...
# Form implementation generated from reading ui file 'c:\Code\Python\Yolov8Tools\main.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_train_resum_time = QtWidgets.QLabel(self.groupBox_4)
        self.label_train_resum_time.setObjectName("label_train_resum_time")
        self.gridLayout_7.addWidget(self.label_train_resum_time, 2, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_train_resume.setText(_translate("MainWindow", "强化训练"))
        self.label_9.setText(_translate("MainWindow", "训练轮数"))
        self.checkBox_train_pretrained.setText(_translate("MainWindow", "权值预载"))
        self.pushButton_run_train.setToolTip(_translate("MainWindow", "<html><head/><body><p>训练时不要关闭该程序，如果一定需要终止训练，请关闭该程序。</p></body></html>"))
        ...
        self.label_train_resum_time.setText(_translate("MainWindow", "----"))
