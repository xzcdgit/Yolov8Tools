...
#自动打标函数
def label_set(model_path:str, img_folder_path:str, labels_out_folder_path:str, is_handle:bool=False):
    # Load a model
...
if __name__ == "__main__":
    ...
    model_path = r"D:\Code\Python\HumanDetection_yolov8\best_s.pt"
    img_folder_path = r"C:\Users\01477483\Desktop\人检加强训练\imgs"
    labels_out_folder_path = r"C:\Users\01477483\Desktop\人检加强训练\labels"
    label_set(model_path, img_folder_path, labels_out_folder_path, False)
    #img_folder_path = r"C:\Users\01477483\Desktop\0601\10.70.37.10_01_20240601110541584.mp4"
    #label_set(model_path, img_folder_path, labels_out_folder_path, True)
